...
@interface DEMGyroscopeViewCell : DEMBaseViewCell

/// Roll label
@property (strong, nonatomic) IBOutlet NSTextField *rollLabel;
/// Pitch label
@property (strong, nonatomic) IBOutlet NSTextField *pitchLabel;
/// Yaw label
@property (strong, nonatomic) IBOutlet NSTextField *yawLabel;
